...
class VisionTransformer_NFI(BaseBackbone):
    ...
    def __init__(self,
                 ...
                 projector=True,
                 use_FFN=True):
        super(VisionTransformer_NFI, self).__init__(init_cfg)
        ...
        if self.projector:
            self.lm_head = nn.Linear(in_features=1024, out_features=1024)
    ...
    def init_weights(self):
        ...
        if (isinstance(self.init_cfg, dict)
            ...
            super(VisionTransformer_NFI, self).init_weights()
    ...
    def forward(self, x):
        ...
        cls_tokens = self.cls_token.expand(B, -1, -1) + mean_feat
