...
class VisionTransformer_FullNFIAgg(BaseBackbone):
    ...
    def __init__(self,
                 ...
                 projector=True,
                 FFN=True):
        super(VisionTransformer_FullNFIAgg, self).__init__(init_cfg)
    ...
    def init_weights(self):
        ...
        if (isinstance(self.init_cfg, dict)
            ...
            super(VisionTransformer_FullNFIAgg, self).init_weights()
