...
class NFIABRegClsHead(ClsHead):
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(NFIABRegClsHead, self).__init__(
    ...
    def init_weights(self):
        super(NFIABRegClsHead, self).init_weights()
    ...
    def loss(self, cls_score, instance_score, cos_sim, gt_label, **kwargs):
        ...
        losses['loss_weakly_cls'] = loss_weakly_cls + 0.2 * cos_sim
