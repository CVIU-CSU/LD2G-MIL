...
from ..utils import MultiheadAttentionRET, PatchEmbed, to_2tuple
...
class TransformerEncoderLayer(BaseModule):
    ...
    def __init__(self,
        ...
        self.attn = MultiheadAttentionRET(
...
class VisionTransformer_FullNFIATT(BaseBackbone):
    ...
    def __init__(self,
                 ...
                 pos_used=True,
                 FFN=True):
        super(VisionTransformer_FullNFIATT, self).__init__(init_cfg)
    ...
    def init_weights(self):
        ...
        if (isinstance(self.init_cfg, dict)
            ...
            super(VisionTransformer_FullNFIATT, self).init_weights()
